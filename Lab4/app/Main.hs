...
getStatistics :: [Publication] -> [(PublicationType, Int)]
getStatistics pubs = [(t, length $ filter (\p -> pubType p == t) pubs) | t <- [Book, Article, ConferencePaper]]
